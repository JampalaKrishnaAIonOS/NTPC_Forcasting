...
def func__model_ets__r(plant_key, raw_series, period, n_days_forecast):
    ...
    sd_r = pd.DataFrame(sd.resid)
    sd_r.columns = [col_name]
    sd_r.fillna(0, inplace=True)
